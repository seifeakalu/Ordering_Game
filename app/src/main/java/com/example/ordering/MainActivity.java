...
public class MainActivity extends Activity {
    ...
    */
    ...
    public void autoanim() {
        autoanim++;
        if (autoanim == 4 && level == 1) {
            load();
            autoanim = 0;
        } else if (autoanim == 8 && level == 2) {
            load();
            autoanim = 0;
        } else if (autoanim == 12 && level == 3) {
            load();
            autoanim = 0;
        } else if (autoanim == 16 && level == 4) {
            load();
            autoanim = 0;
    ...
    public void scaleanim(View v) {
        ...
        ScaleAnimation fade_in = new ScaleAnimation(0 f, 1 f, 0 f, 1 f, Animation.RELATIVE_TO_SELF, 0.5 f, Animation.RELATIVE_TO_SELF, 0.5 f);
    ...
    public void scaldowneanim(View v) {
        ...
        ScaleAnimation fade_out = new ScaleAnimation(1 f, 0 f, 1 f, 0 f, Animation.RELATIVE_TO_SELF, 0.5 f, Animation.RELATIVE_TO_SELF, 0.5 f);
